...
\include{AlgoResearch_4} % исследование алгоритма 
\include{AlgoModern_5} % модернизация алгоритма
\include{AlgoPractice_6} % практическое применение
\include{Development_7} % разработка программных модулей
\include{Results_8} % результаты опробывания программ
