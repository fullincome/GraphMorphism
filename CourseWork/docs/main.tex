...
\include{Problem} % Постановка задачи
\include{Definitions} % определения и обозначения
\include{AlgoStruct} % описание алгоритма
\include{AlgoModern} % исследование и модернизация алгоритма
Практическое применение
Разработка программных модулей
\include{Results} % Результаты опробывания программ
